...
function switchSettingsTab(name, btn){
  btn.closest('.asset-tabs').querySelectorAll('.atab').forEach(b=>b.classList.remove('on'));
  ['theme','credits'].forEach(t=>{ const el=document.getElementById('stab-'+t); if(el) el.style.display='none'; });
  btn.classList.add('on');
